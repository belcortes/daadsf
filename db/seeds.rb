...
n1 = Neighborhood.create(name: "Bayview", r_score: 1)
n2 = Neighborhood.create(name: "Bernal Heights", r_score: 3)
n3 = Neighborhood.create(name: "Castro/Upper Market", r_score: 5)
n4 = Neighborhood.create(name: "Chinatown", r_score: 1)
n5 = Neighborhood.create(name: "Crocker Amazon", r_score: 1)
n6 = Neighborhood.create(name: "Diamond Heights/Glen Park", r_score: 5)
n7 = Neighborhood.create(name: "Downtown/Civic Center", r_score: 1)
n8 = Neighborhood.create(name: "Excelsior", r_score: 2)
n9 = Neighborhood.create(name: "Financial District", r_score: 1)
n11 = Neighborhood.create(name: "Haight Ashbury", r_score: 5)
n12 = Neighborhood.create(name: "Inner Richmond", r_score: 4)
n13 = Neighborhood.create(name: "Inner Sunset", r_score: 4)
n14 = Neighborhood.create(name: "Lakeshore", r_score: 2)
n15 = Neighborhood.create(name: "Marina", r_score: 4)
n16 = Neighborhood.create(name: "Mission", r_score: 2)
n17 = Neighborhood.create(name: "Mission Bay", r_score: 3)
n18 = Neighborhood.create(name: "Nob Hill", r_score: 3)
n19 = Neighborhood.create(name: "Noe Valley", r_score: 5)
n20 = Neighborhood.create(name: "North Beach", r_score: 2)
n21 = Neighborhood.create(name: "Ocean View", r_score: 2)
n22 = Neighborhood.create(name: "Outer Mission", r_score: 2)
n23 = Neighborhood.create(name: "Outer Richmond", r_score: 3)
n24 = Neighborhood.create(name: "Outer Sunset", r_score: 3)
n25 = Neighborhood.create(name: "Pacific Heights", r_score: 5)
n26 = Neighborhood.create(name: "Parkside", r_score: 3)
n27 = Neighborhood.create(name: "Potrero Hill", r_score: 4)
n28 = Neighborhood.create(name: "Presidio", r_score: 5)
n29 = Neighborhood.create(name: "Presidio Heights", r_score: 4)
n30 = Neighborhood.create(name: "Russian Hill", r_score: 4)
n31 = Neighborhood.create(name: "Seacliff", r_score: 5)
n32 = Neighborhood.create(name: "South of Market", r_score: 2)
n33 = Neighborhood.create(name: "Treasure Island YBI", r_score: 1)
n34 = Neighborhood.create(name: "Twin Peaks", r_score: 4)
n35 = Neighborhood.create(name: "Visitacion Valley", r_score: 1)
n36 = Neighborhood.create(name: "West of Twin Peaks", r_score: 5)
n37 = Neighborhood.create(name: "Western Addition", r_score: 3)
