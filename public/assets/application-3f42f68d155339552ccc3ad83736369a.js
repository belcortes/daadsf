  ...
  $.getJSON("/resource", function(json) {
    $.each(json, function(key, data) {
      ...
      if (data.resource_type == 'police_station') {
        ...
        var contentInfo = ("Address: "+" "+data.address+"</br>"+"Phone Number: "+data.phone_number+"</br>"+"Website: "+data.website)
        ...
        var contentInfo = ("Name: "+data.name+"</br>"+"Address: "+" "+data.address+"</br>"+"Phone Number: "+data.phone_number+"</br>"+"Website: "+data.website)
