  ...
  $.getJSON('/publish', function(json){
    $.each(json, function(key, data){
      ...
      $('.checkbox').on('click', function(){
        ...
        var infowindow = new google.maps.InfoWindow({
            content: "<div><img width='254' height='355' src='https://s3-us-west-1.amazonaws.com/sfdaad-production/emails/items/000/000/0"+data.id+"/original/"+data.item_file_name+"'</div>"
        });
