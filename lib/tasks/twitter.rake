...
namespace :twitter do
  ...
  task :fetch => :environment do
    ...
    @client.search('from:SF_emergency OR to:SF_emergency OR from:Cal_OES OR to:Cal_OES OR #emergency OR #SF_emergency OR #disaster OR #sfdisaster', :geocode => '37.781157,-122.398720,8mi').take(150).each do |t|
