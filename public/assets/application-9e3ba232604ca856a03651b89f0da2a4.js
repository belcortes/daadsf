...
function resource_markers() {
  var icon = "/assets/policemarkercolored.png"
  var icon2 = "/assets/firemanmarkercolored.png"
  var icon3 = "/assets/hospitalmarkercolored.png"
...
function user_data() {
  ...
  $.getJSON("/users", function(json) {
    $.each(json, function(key, data) {
      ...
      // } else 
      if (data.school == true) {
        icon = "/assets/SchoolIcon.png"
      } else if (data.church == true) {
        icon = "/assets/churchicon.png"
      }else {
      ...
      $('.resource_links').on('click', function(){
        ...
        console.log(path)
        console.log('^^^^^ path should be images')

         if (data.school == true) {
            marker.setIcon("/assets/SchoolIcon.png")
         } else if (data.church == true) {
            marker.setIcon("/assets/churchicon.png")
         } else {
            marker.setIcon("/assets/person.png")
         }
    ...
    $.each(json, function(key, data) {
      if (data.state == 'DC'){
        ...
        var contentInfo = ("Name:"+" "+data.name+"</br>"+"Address:"+" "+data.address) 
          ...
          geocoder.geocode( { 'address': data.address+data.address2+data.city+'CA'+data.zip}, function(results, status) {
