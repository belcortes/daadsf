      ...
      $('.checkbox').on('click', function(){
        ...
        if ($('#'+check_id).is(':checked') == false) {
          ...
          if (no_image != 'Resources'){
            $('#page-body').append("<img class='theImg' src='/images/"+check_id+".png' />")
          }
          switch (check_id) {
            case 'zip-check':
              sf_zipcodes.setMap(map);
...
function resource_markers() {
  ...
  var icon9 = "/images/bus.png"
  var icon10 = "/images/cooling.png"
...
// function resiliency_output() {
//   $('.mission').on('click', function(){
//     // resiliency.setMap(map);
//     // resiliency.set('preserveViewport', true);
//     var neighbor_name = $(this).val()

//     var not_this = $(this).parent().children().not($(this))

//     // var resiliency_text = $('.resiliency').html()
//     // console.log(not_this)
//     for (var i = 0; i < not_this.length; i++) {
//       var not_this_array = not_this[i].value
//       // console.log(not_this_array)
//     //   // console.log(not_this_array)
//     //   // CHECK IF VALUES IN NOT_THIS_ARRAY ARE IN THE RESILIENCY CONTAINER
//     //   if ($.inArray(not_this_array, resiliency_text) > -1) {
//     //     console.log('not in this string yay!')
//     //     // delete the not_this_neighborhood text
//     //   }
//     }
//     var html_content = '<div class="resiliency-content"><h3>'+neighbor_name+'</h3><p>HELLOOOO</p></div>'
//     $('.container').hide();
//     $('.container2').hide();
...
//         $.each($(data), function(key, value) {
//           if (value.name == neighbor_name) {
//             // console.log(data)
//             console.log('data that should be added ^^')
//             $('.resiliency').append(html_content)
//           } else {
//             // console.log(data)
//             $('.resiliency').remove($('.resiliency-content'))
//             console.log('data that should be removed ^^')
//           }
//         });
//         $('.resiliency-container').show();
//       }
