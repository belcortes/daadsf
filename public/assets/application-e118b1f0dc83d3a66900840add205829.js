...
function user_data() {
  ...
  $.getJSON("/users", function(json) {
    $.each(json, function(key, data) {
      ...
      console.log(trues)
      var contentInfo = ("Name:"+" "+data.name+"</br>"+"Address:"+" "+data.address+"</br>"+"<div style='color:#0062A0; font-weight:bolder; cursor:pointer;'>Contact this owner</div>"+"</br>"+"Resources:"+trues)
      // console.log( sum ); // 3
