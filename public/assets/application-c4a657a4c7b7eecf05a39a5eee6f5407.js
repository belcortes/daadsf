...
function resiliency_output() {
  $('.mission').on('click', function(){
    ...
    // console.log($(this).parent().children().not($(this)).val())
      ...
      success: function(data){
        $.each($(data), function(key, value) {
          ...
          if (value.name == neighbor_name) {
            ...
            // console.log(not($('.resiliency').not($(this)))
            // $('.resiliency').children().remove()
            // console.log('not the fukin data')
            // $('.resiliency-content').remove()
          }
        });
        $('.resiliency-container').show();
        // if($('.resiliency').html().length > 0) {
        //   $('.resiliency-content').last().remove()
        // } else {
        // $('.resiliency').append(html_content)
          // $('.resiliency').children().first().remove()
        // }
