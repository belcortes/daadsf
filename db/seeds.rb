...
n1 = Neighborhood.create(name: "Bayview")
n2 = Neighborhood.create(name: "Bernal Heights")
n3 = Neighborhood.create(name: "Castro/Upper Market")
n4 = Neighborhood.create(name: "Chinatown")
n5 = Neighborhood.create(name: "Crocker Amazon")
n6 = Neighborhood.create(name: "Diamond Heights/Glen Park")
n7 = Neighborhood.create(name: "Downtown/Civic Center")
n8 = Neighborhood.create(name: "Excelsior")
n9 = Neighborhood.create(name: "Financial District")
n10 = Neighborhood.create(name: "Golden Gate Park")
n11 = Neighborhood.create(name: "Haight Ashbury")
n12 = Neighborhood.create(name: "Inner Richmond")
n13 = Neighborhood.create(name: "Inner Sunset")
n14 = Neighborhood.create(name: "Lakeshore")
n15 = Neighborhood.create(name: "Marina")
n16 = Neighborhood.create(name: "Mission")
n17 = Neighborhood.create(name: "Mission Bay")
n18 = Neighborhood.create(name: "Nob Hill")
n19 = Neighborhood.create(name: "Noe Valley")
n20 = Neighborhood.create(name: "North Beach")
n21 = Neighborhood.create(name: "Ocean View")
n22 = Neighborhood.create(name: "Outer Mission")
n23 = Neighborhood.create(name: "Outer Richmond")
n24 = Neighborhood.create(name: "Outer Sunset")
n25 = Neighborhood.create(name: "Pacific Heights")
n26 = Neighborhood.create(name: "Parkside")
n27 = Neighborhood.create(name: "Potrero Hill")
n28 = Neighborhood.create(name: "Presidio")
n29 = Neighborhood.create(name: "Presidio Heights")
n30 = Neighborhood.create(name: "Russian Hill")
n31 = Neighborhood.create(name: "Seacliff")
n32 = Neighborhood.create(name: "South of Market")
n33 = Neighborhood.create(name: "Treasure Island YBI")
n34 = Neighborhood.create(name: "Twin Peaks")
n35 = Neighborhood.create(name: "Visitacion Valley")
n36 = Neighborhood.create(name: "West of Twin Peaks")
n37 = Neighborhood.create(name: "Western Addition")
