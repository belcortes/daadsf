...
function maps() {
  function initialize() {
    ...
    var extreme_heat = new google.maps.KmlLayer({
      url: 'https://dl.dropboxusercontent.com/u/22757148/sf_extreme_heat_layer4.kml'
    });
    ...
    var landslide = new google.maps.KmlLayer({
      url: 'https://dl.dropboxusercontent.com/u/22757148/sf_landslide.kml'
    });
    ...
    var flood_high = new google.maps.KmlLayer({
      url: 'https://dl.dropboxusercontent.com/u/22757148/san_mateo_nfhl_high_risk.kml'
    });
    var floodway_high = new google.maps.KmlLayer({
      url: 'https://dl.dropboxusercontent.com/u/22757148/san_mateo_nfhl_high_risk_floodway.kml'
    });
    var flood_med = new google.maps.KmlLayer({
      url: 'https://dl.dropboxusercontent.com/u/22757148/san_mateo_nfhl_moderate_risk.kml'
    });
    var flood_low = new google.maps.KmlLayer({
      url: 'https://dl.dropboxusercontent.com/u/22757148/san_mateo_nfhl_moderate_to_low_risk.kml'
    });
    var levee_low = new google.maps.KmlLayer({
      url: 'https://dl.dropboxusercontent.com/u/22757148/san_mateo_nfhl_low_to_moderate_levee.kml'
    });
        ...
        if ($('#'+check_id).is(':checked') == false) {
          ...
          switch (check_id) {
            ...
            case 'flood_high':
              ...
              floodway_high.setMap(null);
              break;
            case 'flood_med':
              flood_med.setMap(null);
              break;
            case 'flood_low':
              flood_low.setMap(null);
              levee_low.setMap(null);
              break;
            case 'evac_routes':
          ...
          switch (check_id) {
            ...
            case 'flood_high':
              ...
              floodway_high.setMap(map);
              flood_high.set('preserveViewport', true);
              floodway_high.set('preserveViewport', true);
              break;
            case 'flood_med':
              flood_med.setMap(map);
              flood_med.set('preserveViewport', true);
              break;
            case 'evac_routes':
              ...
              break;
            case 'flood_low':
              flood_low.setMap(map);
              flood_low.set('preserveViewport', true);
              levee_low.setMap(map);
              levee_low.set('preserveViewport', true);
              break;
            case '6ft':
              ft_layer.setMap(map);
...
function resource_markers() {
  ...
  var icon15 = "/images/incident.png"
  var icon16 = "/images/asset.png"
  var icon17 = "/images/resource.png"
  var bounds = new google.maps.LatLngBounds();

  $.getJSON('/incidents', function(json){
    $.each(json, function(key, data){
      if (data.resource != true && data.asset != true) {
      ...
      if (data.resource == true) {
        ...
        $('.checkbox').on('click', function(){
          ...
          $('.incident').mouseover(function(){
            console.log('mouseover on description')
            if($(this).text().trim() == data.description) {
              r_marker.setAnimation(google.maps.Animation.BOUNCE);
              }
            })
          $('.incident').mouseout(function(){
            r_marker.setAnimation(null);
          })
          $('.incident').on('click', function(){
            if($(this).text().trim() == data.description) {
      ...
      if (data.asset == true) {
        ...
        bounds.extend(a_marker.position);
        $('.checkbox').on('click', function(){
          if ($('#assets').is(':checked') == true) {
             a_marker.setMap(map);
              $('.container').hide();
              $('.container2').hide();
          ...
          $('.incident').mouseover(function(){
            console.log('mouseover on description')
            if($(this).text().trim() == data.description) {
              a_marker.setAnimation(google.maps.Animation.BOUNCE);
              }
            })
          $('.incident').mouseout(function(){
