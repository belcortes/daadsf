...
function resource_markers() {
  ...
  $.getJSON('/incidents', function(json){
    $.each(json, function(key, data){
      ...
      var contentInfo = ("<strong>Description:</strong> "+data.description+"</br>"+"<strong>Address:</strong> "+" "+data.address+"</br>"+"<strong>Lat:</strong> "+" "+data.lat+"<strong> Long:</strong> "+" "+data.lng)
